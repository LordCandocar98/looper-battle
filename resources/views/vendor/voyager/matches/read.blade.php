            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-header">
                        <h1 class="panel-title">Room Name: {{ $dataTypeContent->room_name }}</h1>
                    </div>
                    <div class="panel-body">
                        <p><strong>Map:</strong> {{ $dataTypeContent->map }}</p>
                        <p><strong>Mode:</strong> {{ $dataTypeContent->game_mode }}</p>
                        <p><strong>Max Players:</strong> {{ $dataTypeContent->max_players }}</p>
                        <p><strong>Privacy:</strong> {{ $dataTypeContent->privacy }}</p>
                        <hr>
                        <h3>Participants</h3>
                        ...
                        @if ($dataTypeContent->game_mode == 'free_for_all')
                            @if ($winner)
                                <h3>Winner: Player '{{ $winner->player->nickname }}' with score {{ $winner->points }}</h3>
                            @else
                                <h3>No winner found.</h3>
                            @endif
                        @else
                            @if ($winningTeamId !== null)
                                <h3>Winning Team: {{ $playerScore->team->name }}
                                </h3>
                            @else
                                <h3>No winning team found.</h3>
                            @endif
                        @endif
                    </div>
                </div>
